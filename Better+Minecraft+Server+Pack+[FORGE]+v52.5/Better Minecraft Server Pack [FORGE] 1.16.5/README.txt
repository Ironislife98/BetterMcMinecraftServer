...
Click the forge-1.16.5-36.2.20-installer and install server into a new folder 
> Drag config Folder, defaultconfigs folder, mods folder, run.bat, scripts, server-icon and server.properties into the new folder you made 
> run the forge-1.16.5-36.2.22
...
Uninsntall Java 16/17 if still persists
...
These will likely not work as well for Minecraft 1.17/1.18 which uses Java 16/17.
